...
const Home = () => {
  ...
  return (
    <div>
      <Header/>
      <HomeContainer className="home-container" src="https://bpb-us-w2.wpmucdn.com/voices.uchicago.edu/dist/6/983/files/2018/10/shutterstock_590746682-1-vf5uhb.jpg">
      <Container>
        ...
        <CenteredRow>
          <ContentColumn>
            ...
            <Paragraph className='black'>Discover a wide range of Grocery's and Fresh Items for all your needs</Paragraph>
